...
import appPreImg from '../assets/app-nlw-copa-pre.png'
...
export default function Home(props: HomeProps) {
  ...
  async function createPool(event: FormEvent) {
    ...
    try {
      ...
      alert("Bolão criado com sucesso, o code enta na sua aria de transferência (CTRL + V)")
      setPoolTitle('')
    } catch (error) {
      console.log(error);
      alert("Falha ao cria o bolão, tente novamente")
    }
